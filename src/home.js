    ...
    return (
        <div className='flex flex-col items-center justify-center h-screen'>
            <div className='flex flex-row'>
                <Link to="/laboratorio-maker" className='w-80 bg-gradient-to-tr from-orange-500 to-indigo-900 rounded-lg shadow-lg p-4 m-4 flex flex-col items-center justify-center text-white'>
